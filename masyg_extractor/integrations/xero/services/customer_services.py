...
class CustomerService:
    ...
    async def check_customer_exists(
        ...
        if customer_id:
            return await check_entity_exists(request, "Contact", "ContactID", customer_id, client_id=client_id)
        # Otherwise, check by the contact name.
        if customer_name:
            return await check_entity_exists(request, "Contact", "Name", customer_name, client_id=client_id)
        return False
    ...
    async def create_customer(
        ...
        return await create_entity(request, "Contact", customer_name, client_id=client_id)
    ...
    async def fetch_customer_id_by_name(
        ...
        return await fetch_entity_id_by_name(request, "Contact", customer_name, client_id=client_id)
